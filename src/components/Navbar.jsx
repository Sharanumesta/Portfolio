  ...
  return (
    ...
    >
      <div className="h-20 flex items-center justify-between md:px-5 max-w-7xl mx-auto p-4">
        ...
        {/* Mobile Menu Toggle - Now fixed position when menu is open */}
        <motion.div 
          className={`flex items-center gap-4 ${isOpen ? "fixed right-4 top-4 z-50" : "md:hidden"}`}
          whileTap={{ scale: 0.95 }}
        ...
        >
          <motion.button
            ...
            className={ `w-10 h-10 rounded-full flex items-center justify-center ${isOpen ? "hidden":""}  ${
              theme === 'dark'
                ? "bg-yellow-400/10 hover:bg-yellow-400/20 text-yellow-400"
                : "bg-purple-500/10 hover:bg-purple-500/20 text-purple-600"
            }`}
